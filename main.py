...
# кнопочки
calories_button = tk.Button(root, text='Получить данные о калорийности продуктов', command=get_calories_button_click,
                            font=('Arial', 14))
calories_button.pack(pady=10)
calories_button.config(width=40, height=2, bg='white')

exercises_button = tk.Button(root, text='Получить данные о физических упражнениях', command=get_exercises_button_click,
                             font=('Arial', 14))
